...
const path = require('../../prompts/path');
...
const getPrompts = () => [
	...
	promptFunctionName,
	{ ...path, message: 'What\'s the function path?', initial: './src/lambda/{functionName}.js' },
	{
		name: 'hasClient',
		type: 'toggle',
		message: 'Does the function have a client?',
		initial: true,
		active: 'yes',
		inactive: 'no'
	},
...
module.exports.handler = async argv => {
	...
	const { functionName, path: functionPath, hasClient, hasPayload } = options;
