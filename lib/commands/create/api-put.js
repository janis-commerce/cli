...
const apiSchemaTemplate = require('../../templates/api-put-schema');
const apiSchemaFs = require('../../fs/api-schema');

const apiSourceTemplate = require('../../templates/api-put-source');
const apiSourceFs = require('../../fs/api-source');

const apiTestTemplate = require('../../templates/api-put-test');
...
const serverlessFunctionTemplate = require('../../templates/api-put-serverless-function');
...
module.exports.command = 'create-api-put';

module.exports.describe = 'Create a new API Put';
...
module.exports.builder = yargs => {
	...
	return yargs
		...
		.option('entity', {
			alias: 'e',
			description: 'The API Put entity',
			type: 'string'
		})
		.help();
};
...
module.exports.handler = async argv => {
	...
	if(addViews) {
		...
		promises.push(viewSchemaFs.writeSchema(entity, 'edit', editSchema));
	}
